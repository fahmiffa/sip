    ...
    <div class="page-heading">
        <section class="section">
            ...
            @foreach ($da as $item)
                ...
                @endphp
                @if($item->tax == null)              
                    <a href="{{ route('step.tax', ['id' => md5($item->id)]) }}">
                    ...
                    <div class="card rounded shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row mt-3">                        
                                <div class="col-md-4 col-6">
                                    <h6>Tanggal</h6>
                                    {{ dateID($item->tax->tanggal) }}
                                </div>                    
                                <div class="col-md-4 col-6 mb-3">
                                    <h6>File</h6>     
                                    <a target="_blank" href="{{ route('doc.tax', ['id'=>md5($item->id)]) }}" class="btn btn-sm btn-danger"><i class="bi bi-file-pdf"></i></a>     
                                </div>                                                        
                            </div>
                        </div>
                    </div>          
